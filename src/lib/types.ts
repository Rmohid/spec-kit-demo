 ...
 */
export type ReasoningPhase = 'observe' | 'think' | 'plan' | 'act' | 'reflect';
...
/**
 * Options for invoking the reasoning agent.
 */
export interface ReasoningOptions {
  ...
  timeoutMs?: number;
  /** Whether to include detailed steps in output */
  includeSteps?: boolean;
}

/**
 * A tool available to the reasoning agent.
 */
